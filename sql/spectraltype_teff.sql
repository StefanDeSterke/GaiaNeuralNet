SELECT gaiadr3.astrophysical_parameters.spectraltype_esphs,gaiadr3.astrophysical_parameters.teff_esphs
...
AND gaiadr3.gaia_source.random_index BETWEEN 0 AND 500